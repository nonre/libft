...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/27 21:36:46 by bmerkert          #+#    #+#              #
#    Updated: 2019/09/30 18:12:40 by bmerkert         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC	=	ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
		...
		ft_strsplit.c ft_strtrim.c ft_strstr.c	ft_strsub.c \
...
so:
	gcc -shared -o libft.so -fPIC $(SRC)
